...
extension Category {
    ...
    static let resteraunts = Category(id: 502, name: "Resteraunts", icon: .utensils, mainCategoryId: 5)
...
extension Category {
    ...
    static let all: [Category] = ctegories + subCategories
